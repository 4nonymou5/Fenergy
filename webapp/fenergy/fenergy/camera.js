...
function doMathHere(pose) {
  // console.log(pose);
  // document.getElementById("score").innerHTML = "" + new Date().valueOf();
  if ($("#capture_button").text() == "Stop") {
    final_poses = final_poses.concat(pose);
  }
...
$(document).ready(function() {
  $("#capture_button").click(function() {
    console.log("clicked " + $("#capture_button").text() + " button");
    if ($("#capture_button").text() == "Stop") {
      console.log(final_poses);
      final_poses = [];
      $("#capture_button").html("Start");
    }
    else if ($("#capture_button").text() == "Start") {
      $("#capture_button").html("Stop");
    }
  });
});
